...
const PRODUCTS = [
    { id: 'brass-necklace', name: 'Brass Necklaces', category: 'Necklaces', price: 18.60, image: 'africa necklace.jpeg', description: 'A Kelis Africa minimalist brass choker necklace represents a striking contemporary evolution of one of Africa’s oldest and most powerful jewelry forms: the neck torque.' },
    { id: 'masai-beaded-clutch-bag', name: 'maasai-beaded clutch bags', category: 'bags', price: 21.40, image: 'more bags.jpeg', description: 'a beaded clutch purse is far more than a simple fashion accessory—it is a wearable archive of identity, storytelling, and community..' },
    { id: 'beaded-rings', name: 'Beaded-rings', category: 'rings', price: 9.60, image: 'brown ring.jpeg', description: 'Classic brass rings with heritage-inspired shapes and polish.' },
    { id: 'Kiondo-Bags', name: 'Kiondo-Bags', category: 'Bags', price: 10.70, image: 'bags outlined.jpeg', description: 'a masterpiece of sustainable indigenous architecture, deeply rooted in the cultural heritage of the Agĩkũyũ (Kikuyu), Akamba, and Aembu communities of Central and Eastern Kenya..' },
    { id: 'Bolga-Basket', name: 'Bolga-baskets', category: 'Baskets', price: 18.60, image: 'hat+bag.jpeg', description: 'a beautiful testament to the resilience, resourcefulness, and deep-seated community spirit of Northern Ghana.Extensions of the savanna landscape and a profound symbol of matrilineal craftsmanship.' },
    { id: 'beaded-bracelets', name: 'Beaded-bracelets', category: 'Bracelets', price: 8.50, image: 'bangles1.jpeg', description: 'An elegant cuff with engraved cultural symbols and a sleek finish, blending tradition with modern sophistication.' },
    { id: 'Kikapu-Baskets', name: 'Kikapu-baskets', category: 'Baskets', price: 12.70, image: 'bag on stand1.jpeg', description: 'Originating along the Swahili Coast and woven by communities across East Africa, a kikapu is a masterclass in zero-waste design.' },
    { id: 'Sisal-bags', name: 'Sisal-bags', category: 'Baskets', price: 19.40, image: 'trad bag1.jpeg', description: 'A masterclass in resilient, earth-born architecture.The sisal bag has evolved into a global symbol of sustainable luxury.' },
    { id: 'Maasai-beaded-bracelets', name: 'Maasai-beaded-bracelet', category: 'Bracelets', price: 11.10, image: 'bracelets 1.jpeg', description: 'A dynamic visual statement of community standing.Ranging from slim, flexible everyday strands to the iconic rigid cuffs (Enkata)—are packed with deep-seated cultural communication.' },
